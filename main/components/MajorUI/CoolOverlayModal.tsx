...
const CoolOverlayModal: React.FC<CoolOverlayModalProps> = ({
  isOpen,
  onClose,
  properties,
  comparisonObject,
}) => {
  const [activeProperty, setActiveProperty] = useState<number>(
    properties[0].id
  );
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl font-bold mb-4 text-center bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">
              Property Comparison
            </h2>
            <div className="flex items-center justify-center mb-4">
              <Label
                htmlFor="table-view"
                className="mr-2 text-sm font-medium text-white/80"
              >
                Card View
              </Label>
              <Switch
