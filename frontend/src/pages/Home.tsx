                        ...
                        >
                            <div className="space-y-8 backdrop-blur-sm bg-white/5 p-8 rounded-2xl border border-white/10">
                                ...
                                <p className="text-white/80 text-lg md:text-xl max-w-2xl">
                                    Access fractional ownership of high-value
                                    properties through blockchain technology.
                                    Start investing with minimal capital and
                            ...
                            >
                                ...
                                <p className="text-white/80">
                                    <span className="text-[#D0FD3E] font-medium">
                                        1000+
                                    </span>{" "}
                ...
                <section className="container mx-auto px-4 py-20">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: (
                                    <CheckCircle className="w-8 h-8 text-[#D0FD3E]" />
                                ),
                            ...
                            {
                                icon: (
                                    <DollarSign className="w-8 h-8 text-[#D0FD3E]" />
                                ),
                            ...
                            {
                                icon: (
                                    <Building className="w-8 h-8 text-[#D0FD3E]" />
                                ),
                        ...
                        {[
                            {
                                ...
                                quote: "TokenEstate has revolutionized the way I invest in real estate. It's so easy and accessible!",
                            },
                            {
                                name: "Jane Smith",
                                role: "First-time Investor",
                                quote: "I never thought I could own a piece of premium property. Thanks to TokenEstate, now I can!",
                            },
                            {
                                name: "Mike Johnson",
                                role: "Experienced Trader",
                                quote: "The transparency and ease of use of TokenEstate's platform is unmatched in the industry.",
                            },
                ...
                <section className="container mx-auto px-4 py-20">
                    <div className="backdrop-blur-sm bg-white/5 p-8 md:p-12 rounded-2xl border border-white/10 text-center">
                        ...
                        <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
                            Join TokenEstate today and unlock the potential of
                            fractional real estate ownership. Start building
                            your diverse property portfolio with just a few
                            clicks.
                        </p>
                        <motion.div
                            whileHover={{ scale: 1.05 }}
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li>
                                    <Link
                                        to="#"
                                        className="text-white/60 hover:text-[#D0FD3E]"
                                    >
                                        Home
                                    </Link>
                                </li>
